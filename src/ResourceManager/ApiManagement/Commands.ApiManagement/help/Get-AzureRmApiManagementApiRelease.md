...
PS C:\>Get-AzureRmApiManagementApi -Context $ApiMgmtContext -ApiId "echo-api"
```
...
```powershell
PS C:\>$ApiMgmtContext = New-AzureRmApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzureRmApiManagementApi -Context $ApiMgmtContext -ApiId "echo-api" -ReleaseId "version2-release"
```
