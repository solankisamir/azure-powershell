...
online version: https://docs.microsoft.com/en-us/powershell/module/azurerm.apimanagement/set-azurermapimanagementapirelease
schema: 2.0.0
---
...
```
Set-AzureRmApiManagementApiRelease -Context <PsApiManagementContext> -ApiId <String> [-ReleaseId <String>]
 -RevisionId <String> [-Note <String>] [-PassThru] [-DefaultProfile <IAzureContextContainer>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
The **Set-AzureRmApiManagementApiRelease** cmdlet modifies an Azure API Management API Release.
...
PS C:\>Set-AzureRmApiManagementApiRelease -Context $ApiMgmtContext -ApiId "echo-api" -RevisionId "2" -ReleaseId "echo-api-release" -Note "Releasing version 2 of the echo-api to public"
```

This command updates an API Release of Revision `2` of the `echo-api`.
