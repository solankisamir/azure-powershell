...
```
New-AzureRmApiManagementApiRevision -Context <PsApiManagementContext> -ApiId <String> -RevisionId <String>
...
PS C:\>New-AzureRmApiManagementApiRevision -Context $ApiMgmtContext -ApiId "echo-api" -RevisionId "2"
```
