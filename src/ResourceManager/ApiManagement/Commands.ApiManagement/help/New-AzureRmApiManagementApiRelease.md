...
```
New-AzureRmApiManagementApiRelease -Context <PsApiManagementContext> -ApiId <String> -RevisionId <String>
...
PS C:\>New-AzureRmApiManagementApiRelease -Context $ApiMgmtContext -ApiId "echo-api" -RevisionId "2" -ReleaseId "echo-api-release" -Note "Releasing version 2 of the echo-api to public"
```
