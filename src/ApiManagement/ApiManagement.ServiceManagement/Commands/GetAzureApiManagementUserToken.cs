...
namespace Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Commands
{
    ...
    [Cmdlet("Get", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApiManagementUserToken")]
    [OutputType(typeof(string))]
    public class GetAzureApiManagementUserToken : AzureApiManagementCmdletBase
    {
        [Parameter(
        ...
        [Parameter(
            ValueFromPipelineByPropertyName = true,
            Mandatory = false,
            HelpMessage = "Expiry of the Token. If not specified, the token is created to expire after 8 hours. This parameter is required.")]
