...
namespace Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Commands
{
    ...
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ApiManagementApiSchema", DefaultParameterSetName = ExpandedParameterSet)]
    [OutputType(typeof(PsApiManagementApi), ParameterSetName = new[] { ExpandedParameterSet, ByInputObjectParameterSet, ByResourceIdParameterSet })]
    public class SetAzureApiManagementApiSchema : AzureApiManagementCmdletBase
    {
        ...
        public String SchemDocumentContentType { get; set; }
